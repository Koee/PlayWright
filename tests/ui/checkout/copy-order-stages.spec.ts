...
test.describe('Copy Order Stages - All Websites', () => {
    test.setTimeout(QR_READY_TIMEOUT_MS * 6);

    test('should copy order content across order stages for each configured tab @copy @copy-stages @slow', async ({ page }, testInfo) => {
